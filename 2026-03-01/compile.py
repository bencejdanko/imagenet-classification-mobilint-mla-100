...
def main():
    ...
    parser.add_argument("--model", default="test_model/imagenetsub20resnet10-2.onnx", help="Path to input ONNX model")
    ...
    # Specific normalization to match your training/validation
    c_config.preprocess_dict = {
        "Normalize": {
